...
public class E_FractionalProgressWithSamplePoints extends _Behaviour {

	public E_FractionalProgressWithSamplePoints(SimModel simModel) {
		super(simModel);
	}
	...
	private static final String BEHAVIOUR_NAME = "E:Fractional Progress";
	private Robot robot;
